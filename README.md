...
To get started, simply clone the repository, open it in your preferred STM32 toolchain (like STM32CubeIDE), build, and flash it to your board. File main.c is in the DOAN folder, the other are used for debug.
