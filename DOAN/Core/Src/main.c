...
float Setpoint_Angle = 8.0f;
volatile uint32_t cnt = 0;

// --- THÔNG SỐ CẤU HÌNH ---
        float Base_Angle = 8.0f;   // Góc cân bằng chuẩn (Đứng yên)
        float Tilt_Step  = 5.5f;   // Độ nghiêng để chạy tới
        float Ramp_Step  = 0.05f;  // Độ mượt chuyển đổi (tăng số này nếu muốn chuyển trạng thái nhanh hơn)
